...
{$ENDIF}
  ...
  FILEREADPROC = function(buffer: Pointer; length: Cardinal; user: Pointer)
    : Cardinal; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  STREAMPROC = function(handle: HSTREAM; buffer: Pointer; length: Cardinal;
    user: Pointer): Cardinal; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  {
...
type
  ...
  DOWNLOADPROC = procedure(buffer: Pointer; length: Cardinal; user: Pointer);
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  {
  ...
  SYNCPROC = procedure(handle: HSYNC; channel, data: Cardinal; user: Pointer);
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  {
  ...
  DSPPROC = procedure(handle: HDSP; channel: Cardinal; buffer: Pointer;
    length: Cardinal; user: Pointer); {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  {
  ...
  RECORDPROC = function(handle: HRECORD; buffer: Pointer; length: Cardinal;
...
var
  BASS_SetConfig: function(option, value: Cardinal): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_GetConfig: function(option: Cardinal): Cardinal; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SetConfigPtr: function(option: Cardinal; value: Pointer): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  BASS_GetDeviceInfo: function(device: Cardinal; var info: BASS_DEVICEINFO)
...
{$IFDEF MSWINDOWS}
  BASS_GetDSoundObject: function(obj: Cardinal): Pointer; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
{$ENDIF}
  ...
  BASS_PluginLoad: function(filename: PChar; flags: Cardinal): HPLUGIN;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_PluginFree: function(handle: HPLUGIN): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_PluginGetInfo: function(handle: HPLUGIN): PBASS_PLUGININFO;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};

  BASS_Set3DFactors: function(distf, rollf, doppf: FLOAT): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_Get3DFactors: function(var distf, rollf, doppf: FLOAT): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_Set3DPosition: function(var pos, vel, front, top: BASS_3DVECTOR): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_Get3DPosition: function(var pos, vel, front, top: BASS_3DVECTOR): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_Apply3D: procedure(); {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
{$IFDEF MSWINDOWS}
  BASS_SetEAXParameters: function(env: LongInt; vol, decay, damp: FLOAT): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_GetEAXParameters: function(var env: Cardinal;
    var vol, decay, damp: FLOAT): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
{$ENDIF}
  BASS_MusicLoad: function(mem: BOOL; f: Pointer; offset: QWORD;
    length, flags, freq: Cardinal): HMUSIC; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_MusicFree: function(handle: HMUSIC): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};

  BASS_SampleLoad: function(mem: BOOL; f: Pointer; offset: QWORD;
    length, max, flags: Cardinal): HSAMPLE; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleCreate: function(length, freq, chans, max, flags: Cardinal)
    : HSAMPLE; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleFree: function(handle: HSAMPLE): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleSetData: function(handle: HSAMPLE; buffer: Pointer): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleGetData: function(handle: HSAMPLE; buffer: Pointer): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleGetInfo: function(handle: HSAMPLE; var info: BASS_SAMPLE): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleSetInfo: function(handle: HSAMPLE; var info: BASS_SAMPLE): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleGetChannel: function(handle: HSAMPLE; onlynew: BOOL): HCHANNEL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleGetChannels: function(handle: HSAMPLE; channels: Pointer)
    : Cardinal; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_SampleStop: function(handle: HSAMPLE): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};

  BASS_StreamCreate: function(freq, chans, flags: Cardinal; proc: STREAMPROC;
  ...
  BASS_StreamCreateFile: function(mem: BOOL; f: Pointer; offset, length: QWORD;
    flags: Cardinal): HSTREAM; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_StreamCreateURL: function(url: Pointer; offset: Cardinal;
    flags: Cardinal; proc: DOWNLOADPROC; user: Pointer): HSTREAM;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  BASS_StreamGetFilePosition: function(handle: HSTREAM; mode: Cardinal): QWORD;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_StreamPutData: function(handle: HSTREAM; buffer: Pointer;
    length: Cardinal): Cardinal;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_StreamPutFileData: function(handle: HSTREAM; buffer: Pointer;
    length: Cardinal): Cardinal;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};

  BASS_RecordGetDeviceInfo: function(device: Cardinal;
    var info: BASS_DEVICEINFO): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  BASS_RecordGetInfo: function(var info: BASS_RECORDINFO): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_RecordGetInputName: function(input: LongInt): PByteChar;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_RecordSetInput: function(input: LongInt; flags: Cardinal;
    volume: FLOAT): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_RecordGetInput: function(input: LongInt; var volume: FLOAT): Cardinal;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_RecordStart: function(freq, chans, flags: Cardinal; proc: RECORDPROC;
    user: Pointer): HRECORD; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelBytes2Seconds: function(handle: Cardinal; pos: QWORD): Double;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSeconds2Bytes: function(handle: Cardinal; pos: Double): QWORD;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGetDevice: function(handle: Cardinal): Cardinal;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSetDevice: function(handle, device: Cardinal): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelIsActive: function(handle: Cardinal): Cardinal; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGetInfo: function(handle: Cardinal; var info: BASS_CHANNELINFO)
    : BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGetTags: function(handle: HSTREAM; tags: Cardinal): PByteChar;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelFlags: function(handle, flags, mask: Cardinal): Cardinal;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelUpdate: function(handle, length: Cardinal): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelLock: function(handle: Cardinal; lock: BOOL): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelPlay: function(handle: Cardinal; restart: BOOL): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  BASS_ChannelSetAttribute: function(handle, attrib: Cardinal; value: FLOAT)
    : BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGetAttribute: function(handle, attrib: Cardinal; var value: FLOAT)
    : BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSlideAttribute: function(handle, attrib: Cardinal; value: FLOAT;
    time: Cardinal): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelIsSliding: function(handle, attrib: Cardinal): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSet3DAttributes: function(handle: Cardinal; mode: LongInt;
    min, max: FLOAT; iangle, oangle, outvol: LongInt): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGet3DAttributes: function(handle: Cardinal; var mode: Cardinal;
    var min, max: FLOAT; var iangle, oangle, outvol: Cardinal): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSet3DPosition: function(handle: Cardinal;
    var pos, orient, vel: BASS_3DVECTOR): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGet3DPosition: function(handle: Cardinal;
    var pos, orient, vel: BASS_3DVECTOR): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGetLength: function(handle, mode: Cardinal): QWORD;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSetPosition: function(handle: Cardinal; pos: QWORD;
    mode: Cardinal): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGetPosition: function(handle, mode: Cardinal): QWORD;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGetLevel: function(handle: Cardinal): Cardinal; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelGetData: function(handle: Cardinal; buffer: Pointer;
    length: Cardinal): Cardinal;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSetSync: function(handle: Cardinal; type_: Cardinal; param: QWORD;
    proc: SYNCPROC; user: Pointer): HSYNC; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelRemoveSync: function(handle: Cardinal; sync: HSYNC): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSetDSP: function(handle: Cardinal; proc: DSPPROC; user: Pointer;
    priority: LongInt): HDSP; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelRemoveDSP: function(handle: Cardinal; dsp: HDSP): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSetLink: function(handle, chan: Cardinal): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelRemoveLink: function(handle, chan: Cardinal): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelSetFX: function(handle, type_: Cardinal; priority: LongInt): HFX;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_ChannelRemoveFX: function(handle: Cardinal; fx: HFX): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};

  BASS_FXSetParameters: function(handle: HFX; par: Pointer): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
  BASS_FXGetParameters: function(handle: HFX; par: Pointer): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
